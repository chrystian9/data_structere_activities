...
void MaxHeap::heapSort(){
	int aux = tamanho;
	for(int c=0; c<aux; c++) retiraRaiz();
	tamanho = aux;
}	
...
int main (){
	...
	cout << endl << "passo 2.1: Imprimindo os valores do Heap" << endl << endl;
	heap->imprime();
	
	cout << endl << "passo 2.2: HeapSort - ordena" << endl << endl;
	heap->heapSort();
	heap->imprime();
	...
	cout << endl << "passo 3.2: HeapSort - ordena" << endl << endl;
	heap->heapSort();
	heap->imprime();
	...
	cout << endl << "passo 3.1: Retirando metade do heap" << endl << endl;
	for(int c=0; c<5; c++){
		cout << "dado removido: " << heap->retiraRaiz() << endl;
	}
